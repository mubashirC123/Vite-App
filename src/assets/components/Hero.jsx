...
const Hero = () => {
  ...
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    ...
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img class="object-cover object-center rounded" alt="hero" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDlwmgnESGlr1pf9ofuJrtJxHxVIxt1zD6ow&usqp=CAU"/>
    </div>
  </div>
</section>
  )
